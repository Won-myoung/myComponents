...
import styles from "./css/SideMenuDown.module.css";
// import Accordi from "./Accordi";

export default function SideMenuDown() {
  ...
  return (
    <div className={styles.SideMenu}>
      <div className={`${styles.sidebar} ${isOpen ? styles.open : styles.closed}`}>{/* <Accordi /> */}</div>
